...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wujiamingcq"
  # s.authors            = { "wujiamingcq" => "wujiaming@caiqr.com" }
  # s.social_media_url   = "http://twitter.com/wujiamingcq"
  ...
  s.source_files  = "TSNetWork/TSNetWork/*.swift"
  ...
  # s.library   = "iconv"
  #s.libraries = "Alamofire", "HandyJSON", "ReachabilitySwift"
